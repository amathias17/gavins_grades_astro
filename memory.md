...
- Assignment detail scraping now scopes extraction to the visible dialog and checks the current row before trusting cached grades; explicit '* out of X' rows remain ungraded/uncached, while numeric zero scores remain valid grades.
