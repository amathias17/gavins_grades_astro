...
- Payout slang transitions now struggle through a roughly 1.4-second staged scramble with partial fragments, corrupted characters, repeated glitch cycles, width-aware morph scaling, jitter, and a clean final lock-in; reduced-motion users skip the transition.
