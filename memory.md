...
- Payout reels render one fixed-width track per digit, keep separators stationary, and reserve the label layout so multi-digit totals land without shifting.
