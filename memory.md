...
- Payout display includes a centered uppercase client-side rotating slang/joke label (including DOLLARS, BUCKS, BUCKAROOS, DOUGH, MOOLAH, CASH, and SLICES OF BACON) with a 6-second cadence, varied CSS glitch transitions, and reduced-motion fallback.
