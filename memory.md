...
- PayoutDashboard places a compact MissingAssignmentsSummary below the total and before the purchase-equivalent label. It lists scraper-provided assignment, class, due date, and points details, and shows "No missing assignments" when the source list is empty.
