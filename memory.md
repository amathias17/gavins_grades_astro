...
- Missing.Quests cards on the home page open a modal showing projected class grade if the assignment is turned in at 50%, using scraped class points when available.
