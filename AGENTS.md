...
- Assignment detail scraping scopes score parsing to the visible Skyward dialog, validates current-row score markers before using cached grades, and keeps explicit '* out of X' rows uncached and ungraded while preserving numeric zero grades.
