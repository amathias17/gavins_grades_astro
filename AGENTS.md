...
- Homepage payout dashboard renders a compact server-rendered MissingAssignmentsSummary directly below the total, showing assignment, class, due date, and points; an empty list shows an all-clear message.
