...
- Payout homepage shows a server-rendered uppercase "DOLLARS" label centered beneath the number; it rotates through playful money slang and jokes, including "SLICES OF BACON", every 6 seconds with varied CSS glitch transitions, and reduced-motion users see the static label.
