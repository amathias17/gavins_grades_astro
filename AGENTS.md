...
- Payout slang transitions use a roughly 1.4-second staged scramble with partial word fragments, corrupted characters, repeated glitch cycles, jitter, and a clean final lock-in; reduced-motion users skip the transition.
- Payout homepage includes a "Press to Submit Feedback" button that opens an accessible modal containing "lol turn in your assignments." and supports Escape, backdrop click, and focus restoration.
