...
- The payout reveal uses fixed-width per-digit reels with stationary separators, smooth vertical landing, and reserved label space so one-, two-, and three-digit totals do not reflow.
