...
- Homepage shows the current DBZ power-level badge, while /badges provides the full seven-badge collection: Goku (0), Krillin (100), Piccolo (250), Vegeta (500), Gohan (1000), Future Trunks (1500), and final Gogeta (2000). Badge state uses protected quest points and local headshot slots under public/badges; missing artwork renders a placeholder. /badges also displays dynamic collected and remaining badge counts with collection progress derived from unlocked badge state.
