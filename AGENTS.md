...
- Payout homepage shows a server-rendered "dollars" label that rotates through playful money slang every 3 seconds with a CSS glitch transition; reduced-motion users see the static label.
